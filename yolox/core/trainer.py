...
class Trainer:
    ...
    def __init__(self, exp, args):
        ...
        self.is_distributed = False #dist.get_world_size() > 1
    ...
    def before_train(self):
        ...
        if self.use_model_ema:
            #self.ema_model = ExponentialMovingAverage(model,0.9998)
            #self.ema_model.register()#更换了一种方式
        ...
        self.scaler = amp.GradScaler(enable=True, init_loss_scaling=65536.0, incr_every_n_steps=2000)
